...
# Design Name:    Verification IP of spi                                                            //
...
# spi(DUT) by spi's verification IP. This is used in run_test.py for running different number       //
# of constraint random test by spi's VIP.                                                           //
#                                                                                                   //
# How to run?                                                                                       //
#                                                                                                   //
# Excecute the following command                                                                    //
# >> python run_test.py 100                                                                         //
# Here 100 means 100 contraint random tests will be generated by the spi's VIP                      //
